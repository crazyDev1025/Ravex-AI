...
var ScrollTrigger = /*#__PURE__*/ (function (_Component) {
  ...
  function ScrollTrigger(props) {
    ...
    _this.onScrollThrottled = throttle(
      _this.onScroll.bind(_assertThisInitialized(_this)),
      props.throttleScroll,
      {
        trailing: false,
      }
    );
    _this.onResizeThrottled = throttle(
      _this.onResize.bind(_assertThisInitialized(_this)),
      props.throttleResize,
      {
        trailing: false,
      }
    );
  ...
  _proto.checkStatus = function checkStatus() {
    ...
    var velocity =
      lastScrollPosition && lastScrollTime
        ? Math.abs(
            (lastScrollPosition - position) / (lastScrollTime - Date.now())
          )
        : null;
  ...
  _proto.render = function render() {
    ...
    var elementMethod = /*#__PURE__*/ React.isValidElement(component)
      ? "cloneElement"
      : "createElement";
    return React[elementMethod](
      component,
      _objectSpread(
        _objectSpread({}, cleanProps(this.props, ["onProgress"])),
        {},
        {
