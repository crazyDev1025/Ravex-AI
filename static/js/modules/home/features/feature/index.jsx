...
const Feature = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      subparagraph:
        "RAVEX allows users to integrate social login into your games simplifying the process of onboarding new users to the platform. This cuts out the account creation process removing the biggest hurdle in onboarding new gamers to the platform.",
      paragraph:
