...
const faqCategories = [
  {
    ...
    questions: [
      {
        id: "what-is-magmar",
        question: "What is RAVEX?",
        answer:
          "RAVEX is a smart account abstraction infrastructure that enhances blockchain usability by merging smart contracts with externally owned accounts. It enables features like gasless transactions, social recovery, and multi-signature wallets.",
      },
      {
        id: "improve-ux",
        question: "How does RAVEX improve blockchain user experience?",
        answer:
          "RAVEX abstracts away complex wallet management, allowing users to perform transactions without needing to manage private keys directly or pay gas fees upfront, making blockchain more accessible.",
      },
      {
        id: "supported-blockchains",
        question: "What blockchains does RAVEX support?",
        answer:
          "RAVEX currently supports Ethereum and EVM-compatible chains, with plans to expand to multiple Layer 2 and sidechains through its RAVEX Router.",
      },
      {
        id: "magmar-token",
        question: "What is the RAVEX Token (RAVEX) used for?",
        answer:
          "RAVEX is the native utility token for governance, paying transaction fees in the ecosystem, staking, and accessing premium features within RAVEX smart wallets.",
      },
      {
        id: "security",
        question: "How secure is RAVEX?",
        answer:
          "RAVEX incorporates multi-signature wallets, social recovery, and role-based access controls to ensure enhanced security for users' assets and transactions.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        question: "What are smart contract accounts in RAVEX?",
        answer:
      ...
      },
      {
        ...
        question: "Can I use gasless transactions with RAVEX?",
        answer:
    ...
    questions: [
      {
        ...
        question: "What is a Paymaster in RAVEX?",
        answer:
      ...
      },
      {
        ...
        question: "How does RAVEX's Paymaster system choose which transactions to sponsor?",
        answer:
      ...
      {
        id: "payment-tokens",
        question: "What tokens can be used to pay fees via RAVEX Paymasters?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Through the RAVEX Router, gas abstraction can be handled across supported chains, enabling multi-chain fee sponsorship.",
      },
      {
        id: "run-paymaster",
        question: "Can I run my Paymaster?",
        answer:
          "Yes, RAVEX supports third parties running Paymasters to offer fee sponsorship services to specific user groups or dApps.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "wallet-security",
        question: "How does RAVEX enhance wallet security?",
        answer:
      ...
      {
        id: "fraud-protection",
        question: "How does RAVEX protect against transaction replay or fraud?",
        answer:
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-16">
                ...
                <p className="max-w-2xl text-lg leading-relaxed text-white/70">
                  Find answers to common questions about RAVEX, our smart account abstraction infrastructure, and how to build powerful, user-friendly blockchain applications using our developer tools.
                </p>
              </div>
