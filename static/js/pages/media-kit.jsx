...
const mediaKitItems = [
  {
    ...
    title: "RAVEX Brand Assets",
    description:
      "Complete collection of RAVEX brand assets including logos, icons, and brand guidelines for official use.",
    items: [
      {
        id: "logo",
      ...
      },
      {
        ...
        description: "Official Twitter/X banner with RAVEX branding.",
  ...
  },
  {
    ...
    description:
      "High-quality screenshots and images of RAVEX products for marketing and documentation purposes.",
    items: [
      {
        id: "dashboard",
        title: "Dashboard Screenshot",
        description: "Image of the RAVEX dashboard interface.",
    ...
    items: [
      {
        ...
        description: "Visual roadmap showing RAVEX's development timeline.",
        downloadUrl: "/media-kit/Roadmap (1).png",
        icon: "🗺️",
      },
      {
        id: "pitch-deck",
        title: "RAVEX Pitch Deck",
        description: "Official pitch deck presentation (PDF format).",
        downloadUrl: "/media-kit/RAVEX Pitch.pdf",
        icon: "📄",
      },
    ],
  },
  {
    ...
    title: "Video Assets",
    description:
      "Promotional and educational video content showcasing RAVEX's features and onboarding flow.",
    items: [
      {
        id: "welcome-video",
        title: "Welcome Video",
          ...
          <main className="flex-1 px-5 pb-24 lg:px-0">
            ...
            <div className="mb-16">
              ...
              <p className="max-w-2xl text-lg leading-relaxed text-white/70">
                Download official RAVEX brand assets, logos, and marketing
