...
const glossaryTerms = [
  ...
  },
  {
    ...
    content:
      "Programmable accounts governed by smart contract logic instead of private keys. Enable enhanced user features such as upgradeable logic, embedded security controls, and recovery mechanisms. Serve as the foundation for RAVEX's smart wallets.",
  },
  {
    id: "paymaster",
    title: "Paymaster",
    content:
      "An entity within the RAVEX protocol that sponsors transaction fees, allowing users to perform operations without needing ETH. Supports payments in ERC-20 tokens and enables gas abstraction, especially valuable for onboarding new users.",
  },
  {
    id: "paymaster-system",
    title: "Paymaster System",
    content:
      "RAVEX's implementation of fee abstraction. It intelligently sponsors or subsidizes gas fees based on user behavior, wallet score, or dApp integrations, streamlining the user experience and reducing friction.",
  },
  {
    id: "user-operations",
  ...
  },
  {
    ...
    title: "Bundlers",
    content:
      "Actors in the RAVEX ecosystem that collect multiple UserOperations, validate them, and submit them as batch transactions to the blockchain. Help reduce gas overhead and improve scalability.",
  },
  {
  ...
  {
    id: "magmar-token",
    title: "RAVEX Token (RAVEX)",
    content:
      "The native utility token of the RAVEX ecosystem, used for governance, transaction fee subsidies, and accessing premium account features.",
  },
  {
    id: "social-recovery",
  ...
  },
  {
    ...
    content:
      "Transactions submitted and sponsored by third parties on behalf of a user. RAVEX supports meta-transactions via its Paymaster system to improve accessibility and lower entry barriers.",
  },
  {
    id: "session-keys",
    title: "Session Keys",
  ...
  },
  {
    ...
    content:
      "An algorithm within RAVEX's Paymaster system that adjusts the fee subsidy model based on network load, user trust score, and token availability, optimizing cost-efficiency and accessibility.",
  },
  {
  ...
  },
  {
    ...
    content:
      "A dynamic metric based on on-chain activity and behavioral analysis. Determines eligibility for gas sponsorship, increased limits, or other incentives within the RAVEX ecosystem.",
  },
  {
  ...
  },
  {
    ...
    content:
      "A permission model integrated into RAVEX smart wallets allowing assignment of specific roles (e.g., Admin, Executor, Recovery Agent) to different addresses or devices.",
  },
  {
    id: "failproof-ux-layer",
    title: "Failproof UX Layer",
    content:
      "The design layer of RAVEX that handles transaction fallbacks, replay protection, and interface-level alerts to ensure smooth wallet interactions even in edge cases.",
  },
  {
    id: "developer-plugin-registry",
    title: "Developer Plugin Registry",
    content:
      "A modular system within the RAVEX SDK allowing developers to build and integrate custom functionality into smart accounts, such as custom recovery modules, analytics, or dApp connectors.",
  },
  {
  ...
  },
  {
    ...
    title: "RAVEX Revenue Visualizer",
    content:
  ...
  },
  {
    ...
    content:
      "A feature that allows users to fund and execute transactions across one or more supported chains using a single token balance, managed by the RAVEX Router.",
  },
  {
    id: "governance-hooks",
  ...
  },
  {
    ...
    content:
      "Enhanced multi-signature wallet compatibility layers within RAVEX that integrate AI-based transaction analysis, risk scoring, and automatic alerting before signature aggregation.",
  },
  {
  ...
  },
  {
    ...
    title: "RAVEX Chain Compatibility Layer",
    content:
  ...
  },
  {
    ...
    content:
      "A predictive module that estimates future gas fees for planned operations, enabling users and dApps to time transactions for cost efficiency. Integrated with RAVEX's dynamic pricing model.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Allows users to lock RAVEX tokens (MGR) in smart wallets to unlock advanced features, gain voting power, or earn passive rewards through platform engagement.",
  },
  {
    id: "modular-execution-layer",
    title: "Modular Execution Layer",
    content:
      "An architecture layer in RAVEX that allows developers to plug in and execute custom logic paths in user transactions without modifying base contracts.",
  },
  {
  ...
  },
  {
    ...
    title: "RAVEX Signature Aggregator",
    content:
  ...
  },
  {
    ...
    content:
      "Enables project teams or token issuers to sponsor user gas fees in their own tokens, using RAVEX's paymaster framework.",
  },
  {
    id: "magmar-usage-index",
    title: "RAVEX Usage Index (MUI)",
    content:
  ...
  },
  {
    ...
    content:
      "Captures real-time and historical account states for debugging, analytics, and recovery auditing across different RAVEX-compatible chains.",
  },
  {
  ...
  },
  {
    ...
    title: "RAVEX Insight Engine",
    content:
      "An internal analytics system used to surface trends, vulnerabilities, and feature adoption across the RAVEX ecosystem.",
  },
];
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-16">
                ...
                <p className="max-w-2xl text-lg leading-relaxed text-white/70">
                  This document provides definitions for the main RAVEX concepts and terms, along with their relationships to one another. Familiarity with blockchain infrastructure and smart account abstraction is assumed.
                </p>
              </div>
