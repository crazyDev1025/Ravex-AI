    ...
    <div className="text-white min-h-screen">
      ...
      >
        <div className="max-w-[1440px] mx-auto px-4 py-8">
          ...
          <p className="mb-8">
            These Terms of Service govern your access to and use of RAVEX
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Ravex AI LLC provides a set of infrastructure services
          ...
          <section className="mb-8">
            ...
            <p>
              To access or use Ravex AI's services, you must be at least 18
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              You agree not to misuse Ravex AI's services. Misuse includes
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              associated with using RAVEX's tools or deploying smart contracts.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Ravex AI does not provide custody over any digital assets. We
              do not store, recover, or manage your keys. If you lose access to
              your wallet, we cannot assist in recovery.
            </p>
            <p>
              Additionally, Ravex AI does not guarantee uptime, specific
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              associated with Ravex AI is the exclusive property of RAVEX
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Ravex AI reserves the right to restrict or terminate access to
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              To the maximum extent permitted by law, Ravex AI shall not be
              held liable for:
            </p>
            <ul className="list-disc pl-6 mb-4">
            ...
            <p>
              The total liability of Ravex AI shall not exceed the total
          ...
          <section className="mb-8">
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Ravex AI
